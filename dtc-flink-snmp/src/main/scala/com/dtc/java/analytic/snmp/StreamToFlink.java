...
import com.dtc.java.analytic.configuration.Configuration;
...
class myProcessWindowFunction extends ProcessWindowFunction<Tuple5<Tuple2<String, String>, String, String, String,
    ...
    public void process(Tuple tuple, Context context, Iterable<Tuple5<Tuple2<String, String>, String, String, String,
         ...
         */
            ...
            //网卡发包总数(M)
            if(in.f1.contains("101_101_103_101")){
                if(net_bytes_sent.size()!=netCardNumber || netCardNumber==0){
                    net_bytes_sent.put(in.f1,in.f4);
                    continue;
                }else {
            ...
            //网卡收包总数(M)
            if(in.f1.contains("101_101_103_103")){
                if(net_bytes_recv.size()!=netCardNumber || netCardNumber==0){
                    net_bytes_recv.put(in.f1,in.f4);
                    continue;
                }else {
            ...
            //网卡发包总数量（个）
            if(in.f1.contains("101_101_103_105")){
                if(net_packets_sent.size()!=netCardNumber*2 || netCardNumber==0){
                    net_packets_sent.put(in.f1,in.f4);
                    continue;
                }else {
            ...
            //网卡发包总数量（个）
            if(in.f1.contains("101_101_103_106")){
                if(net_packets_recv.size()!=netCardNumber*2 || netCardNumber==0){
                    net_packets_recv.put(in.f1,in.f4);
                    continue;
                }else {
            ...
            //网卡收包错误数量（个）
            if(in.f1.contains("101_101_103_107")){
                if(net_err_in.size()!=netCardNumber || netCardNumber==0){
                    net_err_in.put(in.f1,in.f4);
                    continue;
                }else {
            ...
            //网卡发包错误数量（个）
            if(in.f1.contains("101_101_103_108")){
                if(net_err_out.size()!=netCardNumber || netCardNumber==0){
                    net_err_out.put(in.f1,in.f4);
                    continue;
                }else {
            ...
            //网卡收 丢包数量（个）
            if(in.f1.contains("101_101_103_109")){
                if(net_drop_in.size()!=netCardNumber || netCardNumber==0){
                    net_drop_in.put(in.f1,in.f4);
                    continue;
                }else {
             ...
             */
            //Linux内存空闲率
            if (getMessage_Two(collector, map, in, "101_101_104_110", "113", "114")) continue;
            ...
            //内存已用百分比和已用内存
            if (in.f1.equals("101_101_104_109")) {
                if (in.f2.equals("111")) {
                    map.put("101_101_104_109_111", in.f4);
                    if (map.containsKey("101_101_104_109_112")) {
                        ...
                        String result = (1 - (mem_available / mem_total))*100 +"";
                        String result1 =  (mem_total-mem_available)/1024+"";
                        collector.collect(Tuple6.of(in.f0.f0, in.f0.f1, in.f1, "000", in.f3, result));
                        collector.collect(Tuple6.of(in.f0.f0, in.f0.f1, "101_101_104_102", "000", in.f3, result1));
                ...
                if (in.f2.equals("112")) {
                    ...
                    if (map.containsKey("101_101_104_109_111")) {
                        double mem_total = Double.parseDouble(map.get("101_101_104_109_111").toString());
                        double mem_available = Double.parseDouble(map.get("101_101_104_109_112").toString());
                        String result = (1 - (mem_available / mem_total)*100)+"";
                        String result1 =  (mem_total-mem_available)/1024+"";
        ...
        if (in.f1.contains(s)) {
            if (in.f2.equals(s2)) {
                ...
                if (map.containsKey(in.f1+s3)) {
                    ...
                    String result = memory_available / memory_All +"";
                    collector.collect(Tuple6.of(in.f0.f0, in.f0.f1, in.f1, "000", in.f3, result));
                    map.remove(in.f1+s2);
                    map.remove(in.f1+s3);
                    return true;
