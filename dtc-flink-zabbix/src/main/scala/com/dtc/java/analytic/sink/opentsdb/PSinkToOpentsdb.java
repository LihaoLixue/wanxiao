package com.dtc.java.analytic.sink.opentsdb;
 ...
 * @author :hao.li
 */
public class PSinkToOpentsdb extends RichSinkFunction<Tuple7<String, String, String, String, String, Long, Double>> {
    ...
    public void invoke(Tuple7<String, String, String, String, String, Long, Double> value) {
        String ip;
        String host;
        String oid;
        String name;
